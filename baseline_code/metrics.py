...
def evaluate(prediction_path, annotation_path, yaml_path, mode, is_train=False):
    ...
    # Parse ground truth.
    gt_df = parse_ground_truth(annotation_path, yaml_path, is_train=is_train)
...
def parse_ground_truth(annotation_path, yaml_path, is_train=False):
    """
    ...
    if is_train:
        gt_df = ann_df[(ann_df["annotator_id"]==0) & (ann_df["split"]=="train")]
    else:
        gt_df = ann_df[(ann_df["annotator_id"]==0) & (ann_df["split"]=="validate")]
